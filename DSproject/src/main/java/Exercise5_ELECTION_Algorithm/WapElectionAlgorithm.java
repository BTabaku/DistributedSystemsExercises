 ...
 ** created on 1/13/2020 inside the package - Exercise5_ELECTION_Algorithm
 **
 */
...
public class WapElectionAlgorithm implements Runnable{
    ...
    public WapElectionAlgorithm(String operation) {
        this.operation = operation;

    }

    public WapElectionAlgorithm(String operation, String reqtype) {
        this.operation = operation;
    ...
    public static void main(String args[]) throws UnknownHostException, IOException, InterruptedException{
        initialize();
        Runnable receiver = new WapElectionAlgorithm("receiver");
        new Thread(receiver).start();

        // Thread.sleep(10);


        Runnable heartbeat = new WapElectionAlgorithm("heartbeat");
        ...
        if(operation.equals("timer")){
            ...
            try{
                ...
                if(!received){
                    ...
                    Runnable sender = new WapElectionAlgorithm("sender","cood");
                ...
                if(received && !leader_flag){
                    ...
                    Runnable sender = new WapElectionAlgorithm("sender","elecreq");
                    new Thread(sender).start();
                ...
                while(true){
                    ...
                    if(option.equals("elecreq")){
                        ...
                        if(self_id>source_id){
                            Runnable sender = new WapElectionAlgorithm("sender","ok");
                            new Thread(sender).start();
                        ...
                        if(!election_req){
                            ...
                            Runnable timer = new WapElectionAlgorithm("timer");
